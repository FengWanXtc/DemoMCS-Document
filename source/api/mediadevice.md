# 4.2 Mediadevice——mediadevicelib

## 4.2.1 get_md_audio_in
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1001_device_get_audio_in.py

  ![docker_image](picture/md_audio_in.png)

## 4.2.2 get_md_audio_out
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1002_device_get_audio_out.py

  ![docker_image](picture/md_audio_out.png)
  
## 4.2.3 get_md_video_in
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1003_device_get_video_in.py

  ![docker_image](picture/md_video_in.png)
  
## 4.2.4 get_md_video_out
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1004_device_get_video_out.py

  ![docker_image](picture/md_video_out.png)

## 4.2.5 get_md_audio_in_capability
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1005_device_get_audio_in_capability.py

  ![docker_image](picture/md_audio_in_cap.png)

## 4.2.6 get_md_audio_out_capability
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1006_device_get_audio_out_capability.py

  ![docker_image](picture/md_audio_out_cap.png)

## 4.2.7 get_md_video_in_capability
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1007_device_get_video_in_capability.py

  ![docker_image](picture/md_video_in_cap.png)

## 4.2.8 get_md_video_out_capability
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1008_device_get_video_out_capability.py

  ![docker_image](picture/md_video_out_cap.png)


## 4.2.9 get_md_video_out_background
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1009_device_get_video_out_background.py
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1010_device_get_md_list.py

  ![docker_image](picture/md_list.png)


## 4.2.11 get_audio_in_configuration
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1011_device_get_audio_in_cfg.py

  ![docker_image](picture/md_audio_in_cfg.png)

## 4.2.12 get_audio_out_configuration
- 函数声明:
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1012_device_get_audio_out_cfg.py

  ![docker_image](picture/md_audio_out_cfg.png)

## 4.2.13 get_md_director_strategy
- 函数声明:
```
...
- Metis-MCS 演示效果
  ...
  脚本：Metis-MCS\01_Basic_Tests\MA_API_Basic_Tests\1013_device_get_director_strategy.py
